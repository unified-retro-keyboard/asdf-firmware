 ...
 */
uint8_t asdf_dropped_codes(const asdf_t *kb) { return asdf_ring_dropped(&kb->keycodes); }
 ...
 */
uint8_t asdf_dropped_messages(const asdf_t *kb) { return asdf_ring_dropped(&kb->messages); }
 ...
 */
uint8_t asdf_keymap_errors(const asdf_t *kb) { return kb->keymap.errors; }
 ...
 * @param kb  Keyboard.
 */
void asdf_keyscan(asdf_t *kb) { asdf_scan_elapsed(kb, 1); }
