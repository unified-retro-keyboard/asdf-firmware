...
const FLASH ace1000_keycode_matrix_t ace1000_ctrl_matrix = {
    ...
    // [6][0] = ACTION_FN_10: ID-message hook trigger; CTRL+0 fires ACTION_FN_10 -> ASDF_HOOK_USER_10 -> ace1000_id_message
    [6] = { ACTION_FN_10, ACE_KEY_CTRL_P, ACE_KEY_CTRL_SEMI, ACE_KEY_CTRL_SLASH, ACE_KEY_CTRL_7,
            ACE_KEY_CTRL_4, ACE_KEY_CTRL_1, ACE_KEY_CTRL_GT,  },
