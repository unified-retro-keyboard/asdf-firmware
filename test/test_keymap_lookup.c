...
static void load_keymap(const asdf_key_t *plain_matrix, uint8_t plain_rows, uint8_t plain_cols,
                        const asdf_key_t *shift_matrix, uint8_t shift_rows, uint8_t shift_cols)
{
...
{
  load_keymap((const asdf_key_t *) small_plain_matrix, 2, 2, NULL, 0, 0);
